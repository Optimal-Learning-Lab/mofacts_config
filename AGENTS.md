...
- For runtime behavior, UI rendering, themes, transitions, Svelte components, state machines, or application logic, switch to `C:\dev\MoFaCTS` and prefer `mofacts/`.
...
- `C:\dev\MoFaCTS.wiki` (documentation)
